      ...
      <div className="container mx-auto px-4 max-w-[1180px]">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex flex-col items-center md:items-start text-center md:text-left gap-2 mb-6 md:mb-0">
            <span className="font-serif text-[1.5rem] leading-none tracking-tight text-[#001736]">Blueverra</span>
            <p className="text-[0.8rem] text-[#4d5b6a] max-w-sm">
              An educational initiative dedicated to raising awareness about our environment and technological footprint.
            </p>
          </div>
